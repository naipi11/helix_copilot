...
impl Client {
    ...
    /// Request inline completion (ghost text) from the language server.
    pub fn inline_completion(
        ...
        // Return early if the server does not support inline completion.
        capabilities.inline_completion_provider.as_ref()?;
